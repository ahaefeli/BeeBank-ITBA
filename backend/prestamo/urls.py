...
from .views import PrestamoView, PrestamoEmpleadoView, PrestamoEmpleadoDeleteView, PrestamoPermitidoView
...
urlpatterns = [
    ...
    path('cliente/permitido/<int:customer_id>', PrestamoEmpleadoView.as_view(), name='prestamo_empleado_data'),
