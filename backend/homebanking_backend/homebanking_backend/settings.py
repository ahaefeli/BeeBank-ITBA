...
SECRET_KEY = 'django-insecure--x@ocwoo-$_-owjtm(h)^woj^4xk*0#-^%q%d+ff!s2ru-=-q%'
...
ROOT_URLCONF = 'homebanking_backend.urls'
...
WSGI_APPLICATION = 'homebanking_backend.wsgi.application'
...
STATICFILES_DIRS = [
    ...
    Path(BASE_DIR).joinpath("faq", "static"),
]
