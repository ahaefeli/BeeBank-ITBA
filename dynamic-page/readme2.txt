...
a 8 digitos y que contenga una mayuscula un numero y un caracter especial, esto se simboliza mediante un pop up rojo de error(echo con js)
...
erroneamente al dividir por 12.
