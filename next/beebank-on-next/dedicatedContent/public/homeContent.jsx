...
import stylesIndex from '../src/css/dedicated/index.module.css'

export default function HomeContent() {

  /*  Sacar el comentario cuando agregue la funcionalidad del slider dentro del componente
    ...
    <div>
      <div className={stylesIndex.homeWelcome}>
        <div className={stylesIndex.carousel}>
          ...
          <div className={stylesIndex.carousel__carouseles} id="slider">
          ...
          <div className={stylesIndex.carousel__rightBtn}><i className="bi bi-chevron-right" /></div>
        </div>
      </div>
      <div className={stylesIndex.objectives}>
        <div className={stylesIndex.objectives__intro}>
        ...
        <div className={stylesIndex.objectives__all}>
          <div className={stylesIndex.objectives__all__objective}>
      ...
      <div className={stylesIndex.products}>
        <div className={stylesIndex.products__title}>
          <h2>Nuestros servicios</h2>
        </div>
        <div className={stylesIndex.products__list}>
          <div className={stylesIndex.products__list_product}>
