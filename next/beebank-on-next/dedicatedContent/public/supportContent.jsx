    ...
    <div>
      ...
      <div className="faq">
        <div className="faq__questionContainer">
          <div className="question">¿Cómo me creo una cuenta de BeeBank?</div>
          <div className="answer">Registrarte en BeeBank es sencillo. Selecciona <a href="#">Únete a nosotros</a> en la barra de
            navegación y sigue las instrucciones para completar el proceso. Ten el documento a mano para verificar tu
            identidad.</div>
        </div>
        <div className="faq__questionContainer">
          <div className="question">¿Cómo puedo recuperar mi contraseña si la olvidé?</div>
          <div className="answer">Si has olvidado tu contraseña, ve a la página de inicio de sesión y selecciona <a href="#">¿Olvidaste tu
            contraseña?</a> Ingresa tu número de cuenta o el mail y sigue las indicaciones para restablecer tu contraseña de
            forma segura.</div>
        </div>
        <div className="faq__questionContainer">
          <div className="question">¿Cómo puedo pagar mis facturas con Beebank?</div>
          <div className="answer">Pagar tus facturas es simple con Beebank. Accede a tu cuenta, selecciona la opción <a href="#">Pagos</a>,
        ...
        <div className="faq__questionContainer">
          <div className="question">¿Qué hago si veo una transacción que no hice en mi historial?</div>
          <div className="answer">Si notas una transacción no autorizada, te recomendamos actuar de
