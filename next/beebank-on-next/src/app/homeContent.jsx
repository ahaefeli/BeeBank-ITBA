        ...
        <div className={stylesIndex.carousel}>
          ...
          <div className={stylesIndex.carousel__carouseles} id='slider' style={sliderStyle}>
            <section className={stylesIndex.slider_section} id='slider-section'>
              <Image quality={100} width={widthScreen} height={768} src={'https://raw.githubusercontent.com/ahaefeli/BeeBank-ITBA/main/src/resources/uc.png'} draggable='false' />
            </section>
            <section className='slider-section'>
              <Image quality={100} width={widthScreen} height={768} src={'https://raw.githubusercontent.com/ahaefeli/BeeBank-ITBA/main/src/resources/uc2.png'} draggable='false' />
            </section>
            <section className={stylesIndex.slider_section}>
              <Image quality={100} width={widthScreen} height={768} src={'https://raw.githubusercontent.com/ahaefeli/BeeBank-ITBA/main/src/resources/uc3.png'} draggable='false' />
            </section>
