  ...
  return (
    <footer>
      <div className={styleFooter.footer}>
        ...
        <div className={'${styleFooter.footer_info} ${styleFooter.responsive-footer}'}>
          <p className={styleFooter.footer_text}>BeeBank © 2023 <label>Todos los derechos reservados</label></p>
          <p className={styleFooter.footer_text}>Av. Eduardo Madero 399, <label>Ciudad de Buenos Aires, Argentina</label></p>
        </div>
        <div className={'${styleFooter.footer_social} ${responsive_footer}'}>
