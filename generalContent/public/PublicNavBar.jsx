    ...
    <div className="public-nav-bar">
      <nav>
        <ul className={styleNav.public_navigation}>
          <li><Link href='/'><Image className={styleNav.public_logo} quality={90} sizes='720px' width={60} height={45} src={'https://raw.githubusercontent.com/ahaefeli/BeeBank-ITBA/main/src/resources/beebank-logo-claro.png'} alt="Logo" draggable="false"/></Link></li>
